      ...
      class AssociationsDSL < BasicObject
        ...
        def one_to_many(target, options = {})
          if options[:through]
            ...
            add(Associations::Definitions::OneToMany.new(source, target, options))
          end
        end
        ...
        def one_to_one(target, options = {})
          if options[:through]
            ...
            add(Associations::Definitions::OneToOne.new(source, target, options))
          end
        end
        ...
        def one_to_one_through(target, options = {})
          add(Associations::Definitions::OneToOneThrough.new(source, target, options))
        end
        ...
        def many_to_many(target, options = {})
          add(Associations::Definitions::ManyToMany.new(source, target, options))
        end
        ...
        def many_to_one(target, options = {})
          add(Associations::Definitions::ManyToOne.new(source, target, options))
        end
